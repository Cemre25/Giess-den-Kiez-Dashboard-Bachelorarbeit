...
# df_merged_full <- fread("C:/Users/cahid/Documents/Studium/Bachelorarbeit/data/df_merged_final.csv", sep = ";", encoding = "UTF-8")
# 
...
#     .groups = "drop"
#   )
# write.csv2(df_merged_sum, file = "C:/Users/cahid/Documents/Studium/Bachelorarbeit/data/df_merged_gesamter_baumbestand_sum1.csv", sep = ";")


# # --- df_merged_gesamter_baumbestand minimieren ---
# df_merged_full <- fread("C:/Users/cahid/Documents/Studium/Bachelorarbeit/data/df_merged_final.csv",
#                         sep = ";", encoding = "UTF-8")
# 
...
# )]
# 
# write.csv2(df_merged, file = "C:/Users/cahid/Documents/Studium/Bachelorarbeit/data/df_merged_gesamter_baumbestand_minimal.csv", sep = ";")
# 



# # --- df_merged minimieren ---
# df_merged_full <- fread("C:/Users/cahid/Documents/Studium/Bachelorarbeit/data/orginal/df_merged.csv", 
#                         sep = ";", encoding = "UTF-8")
# 
# df_merged <- df_merged_full[, .(
...
# )]
# 
# write.csv2(df_merged, file = "C:/Users/cahid/Documents/Studium/Bachelorarbeit/data/df_merged_minimal.csv", sep = ";")
...
# 
# pumpen <- pumpen_full %>% 
#   select(pump, pump.style, geometry, pump.status, man_made, id)
# 
...
pumpen_mit_bezirk <- pumpen_mit_bezirk_full %>% 
  select(pump, pump.style, pump.status, Gemeinde_name, geometry, man_made, id)
