...
df_clean <- read.csv("C:/Users/cahid/Documents/Studium/Bachelorarbeit/data/giessdenkiez_bewässerungsdaten.csv", sep = ";", stringsAsFactors = FALSE, fileEncoding = "UTF-8") %>%
...
write.csv2(df_merged, "C:/Users/cahid/Documents/Studium/Bachelorarbeit/data/df_merged_final.csv", row.names = FALSE, fileEncoding = "UTF-8")
