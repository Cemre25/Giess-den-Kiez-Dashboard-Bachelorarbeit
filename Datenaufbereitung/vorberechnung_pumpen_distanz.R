...
# # 1. Daten einlesen
pumpen_mit_bezirk <- st_read("C:/Users/cahid/Documents/Studium/Bachelorarbeit/data/pumpen_mit_bezirk_minimal.geojson")
df_merged_sum <- read.csv("C:/Users/cahid/Documents/Studium/Bachelorarbeit/data/df_merged_gesamter_baumbestand_sum1.csv", sep = ";", stringsAsFactors = FALSE, fileEncoding = "UTF-8")

n_distinct(pumpen_mit_bezirk$id)
n_distinct(df_merged_sum$gisid)
# 
